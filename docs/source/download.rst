...
.. tab-set::
    ...
    .. tab-item:: Windows
      ...
      .. button-link:: https://github.com/psychopy/psychopy/releases/download/2024.2.4/StandalonePsychoPy-2024.2.4-win64-py3.10.exe
          :color: primary

          PsychoPy 2024.2.4 modern (py3.10)

      .. button-link:: https://github.com/psychopy/psychopy/releases/download/2024.2.4/StandalonePsychoPy-2024.2.4-win64-py3.8.exe
          :color: primary
    ...
    .. tab-item:: MacOS
      ...
      .. button-link:: https://github.com/psychopy/psychopy/releases/download/2024.2.4/StandalonePsychoPy-2024.2.4-macOS-py3.10.dmg
          :color: primary

          PsychoPy 2024.2.4 modern (py3.10)

      .. button-link:: https://github.com/psychopy/psychopy/releases/download/2024.2.4/StandalonePsychoPy-2024.2.4-macOS-py3.8.dmg
          :color: primary
